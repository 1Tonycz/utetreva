...
![Nette Framework](https://nette.org/img/logo.svg)

A basic skeleton application for Nette web projects.
See the [documentation](https://doc.nette.org/en/web-project) for more details.
=================
